 ...
 */
public class DriveStraightSwerveWithUltraAway extends DriveStraight {
     ...
     */
    public DriveStraightSwerveWithUltraAway(SwerveDrive drive, double xSpeed, double ySpeed, double distance, double ultra) {
