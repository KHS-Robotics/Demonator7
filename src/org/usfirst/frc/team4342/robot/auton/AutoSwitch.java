...
{	
	...
	private static final double LEFT_RIGHT_SWITCH_DISTANCE = 45 - (ROBOT_Y);
	// Start Position and Switch location are opposite
	private static final double LEFT_RIGHT_PAST_SWITCH_DISTANCE = 210;
	private static final double LEFT_RIGHT_PAST_SWITCH_ALIGN_DISTANCE = 170 - (ROBOT_X/2);
	private static final double LEFT_RIGHT_MOVE_TO_SWITCH_DISTANCE = 10;
...
//					this.addSequential(new DriveStraightSwerve(d, -0.7, 0.0, LEFT_RIGHT_PANEL_ALIGN_DISTANCE));
//					this.addSequential(new DriveStraight(d, -0.4, LEFT_RIGHT_SWITCH_DISTANCE));
...
//				else
//				{
					this.addSequential(new DriveStraightSwerve(d, -0.7, 0.0, LEFT_RIGHT_PAST_SWITCH_DISTANCE));
					this.addParallel(new ElevateToSwitch(e));
